...
<div style='margin-top: 25px;' id="myBody">
	<!-- Nav tabs -->
	<ul class="nav nav-tabs" role="tablist">
		<li role="presentation" class="active"><a href="#zichuzhi"
												  aria-controls="home" role="tab" data-toggle="tab">科室处理</a></li>
	...
	$(function(){
		for(var index=0;index<$(".tab-pane").length;index++){
			...
			$('#tab'+_index).click(function(){
				...
				// }
				if (flag){
                    submitForm('frm'+$(this).attr("tab_num"),'/task/subdistrictOfficeHandle');
				}

        	})
		}
	})
    $('#myBody').on('hidden.bs.modal', function () {
