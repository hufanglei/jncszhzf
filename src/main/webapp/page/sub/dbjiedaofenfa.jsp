			...
			<form class='form-horizontal clearfix' id="frm1" method="post"
				...
				<div class="clearfix">
					<div class="form-group col-sm-8">
						...
						<textarea class="form-control" rows="3" v-model='area1'
		...
		<div role="tabpanel" class="tab-pane" id="paifa">
			<form class='form-horizontal clearfix' id="frm2" method="post"
				...
				<div class="clearfix">
					<div class="form-group col-sm-8">
						<div class="biaoti"><span style="color: red"> * </span>办理意见：</div>
						<textarea class="form-control" rows="3" v-model='area2'
							name='comment'></textarea>
					</div>
				</div>
				<div class="clearfix">
				...
				<div class="clearfix">
					<div class="form-group col-sm-12"  align="center" style="margin-top: 20px">
		...
		<div role="tabpanel" class="tab-pane" id="shangbao">
			<form class='form-horizontal clearfix' id="frm3" method="post"
				...
				<div class="clearfix">
					<div class="form-group col-sm-8">
						<div class="biaoti"><span style="color: red"> * </span>办理意见：</div>
						<textarea class="form-control" rows="3" v-model='area3'
							name='comment'></textarea>
					</div>
				</div>
				<div class="clearfix">
		...
		<div role="tabpanel" class="tab-pane" id="xianxiaducha">
			<form class='form-horizontal clearfix' id="frm4" method="post"
				...
				<div class="clearfix">
					<div class="form-group col-sm-8">
						<div class="biaoti"><span style="color: red"> * </span>办理意见：</div>
						<textarea class="form-control" rows="3" v-model='area4'
							name='comment'></textarea>
					</div>
				</div>
                <div class="clearfix">
	...
	$(function(){
		for(var index=0;index<$(".tab-pane").length;index++){
			...
			$('#tab'+_index).attr("tab_num",_index);
	    		...
	    		submitForm('frm'+$(this).attr("tab_num"),'/taskDb/subdistrictOfficeDistribute');
	    	})
		}
	})
</script>
