...
<div style='margin-top: 25px;' id="wgyzcz">
	<!-- Nav tabs -->
	<!-- Tab panes -->
	<div class="tab-content sqzcz" style='background: #fff;' >
			...
			<form class='form-horizontal clearfix' id="frm1" method="post"
				...
				<div class="clearfix">
					...
					<div class="form-group col-sm-4">
						...
						<div class="handle-list" style="height:80px; border: 1px solid #ccc">jiedaofenfa.jsp
						</div>
					</div>
				</div>
				...
				<div class="clearfix" align="center" style="margin-top: 20px">
					<div class="form-group col-sm-12">
						<button class='btn btn-success' id='tab1' type='submit'>提交</button>
					</div>
				</div>
			</form>
		</div>
			...
			$('#tab' + _index).click(
					function() {
                       ...
                       /* var  fujian=$('#uploadFile').val();
                        ...
                        if (flag) {
                           submitForm('frm' + $(this).attr("tab_num"), '/task/handleSelf');
                        }
					});
		};
	});
    $('#wgyzcz').on('hidden.bs.modal', function () {
