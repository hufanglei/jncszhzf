...
<div style='margin-top: 25px;'id="jdzcz">
    <!-- Nav tabs -->
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#zichuzhi"
                                                  aria-controls="home" role="tab" data-toggle="tab">网格员自处置</a></li>
    ...
    $(function () {
        for (var index = 0; index < $(".tab-pane").length; index++) {
            ...
            $('#tab' + _index).click(function () {
                ...
                if (flag) {
                    submitForm('frm' + $(this).attr("tab_num"), '/task/gridHandle');
                }
            })
        }
    })
    $('#jdzcz').on('hidden.bs.modal', function () {
