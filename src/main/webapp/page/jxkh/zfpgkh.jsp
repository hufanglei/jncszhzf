...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/jxkh/zfpgkh.js"></script>
...
<!-- 二级标签选中 -->
<input id="nav-flag-sub" type="hidden" value="nav-flag-sub-gdgx-zfpgkh" />
<!-- 导航辅助 结束 -->
    ...
    <div class="minheight">
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">作风评估</div>
