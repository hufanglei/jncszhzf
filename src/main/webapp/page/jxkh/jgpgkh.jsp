...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/jxkh/jgpgkh.js"></script>
...
<!-- 二级标签选中 -->
<input id="nav-flag-sub" type="hidden" value="nav-flag-sub-gdgx-jgpgkh" />
<!-- 导航辅助 结束 -->
    ...
    <div class="minheight">
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">结果评估</div>
                ...
                <div id="MyDiv" class="white_content">
                    ...
                    <form  class='form-horizontal clearfix' id="addPostForm" method="post" enctype="multipart/form-data">
                        <table class="table" style="height: 300px;text-align: left;">
                            ...
                            <tr>
                                <th>问责来源</th>
                                <th><input type="text" name="source"  class="form-control" aria-describedby="basic-addon1" placeholder="问责来源"></th>
                                <th height="34px;">问责内容</th>
                                <th><textarea type="text" name="content"  class="form-control" aria-describedby="basic-addon1" placeholder="请输入问责内容"></textarea>
                                </th>
                            </tr>
                            <tr>
                                <th>被问责机构</th>
                                ...
                                <th>问责扣分</th>
                                <th><input type="number" name="score"  class="form-control" aria-describedby="basic-addon1" placeholder="请输入问责扣分"></th>
                            </tr>
                            <input type="hidden" name="type" value="02"> <%--问责类型 --%>
                ...
                <div id="EditDiv" class="white_content">
                    ...
                    <form  class='form-horizontal clearfix' id="editPostForm" method="post" enctype="multipart/form-data">
                        <table class="table" style="height: 300px;text-align: left;">
                            <tr>
                                <th height="34px;">问责来源</th>
                                <th><input type="text" name="source"  class="form-control" aria-describedby="basic-addon1" placeholder="请输入问责来源" >
                                </th>
                                <th height="34px;">问责内容</th>
                                <th><textarea  name="content"  class="form-control" aria-describedby="basic-addon1" placeholder="请输入问责内容"></textarea>
                                </th>
                            </tr>
                            <tr>
                                <th>被问责机构</th>
                        ...
                        <%--<input type="hidden" name="type" value="02"> &lt;%&ndash;类型&ndash;%&gt;--%>
                        <div class="btn-group" role="group" aria-label="" style="margin-left: 40%;">
