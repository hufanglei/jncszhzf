...
<!-- 二级标签选中 -->
<input id="nav-flag-sub" type="hidden" value="nav-flag-sub-gdgx-jdjckh" />
<!-- 导航辅助 结束 -->
    ...
    <div class="minheight">
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">监督检查</div>
                ...
                <div id="MyDiv" class="white_content">
                    ...
                    <form  class='form-horizontal clearfix' id="addPostForm" method="post" enctype="multipart/form-data">
                        <table class="table" style="height: 300px;text-align: left;">
                            ...
                            <tr>
                                <th>检查问题来源</th>
                                <th><input type="text" name="source"  class="form-control" aria-describedby="basic-addon1" placeholder="检查来源"></th>
                                <th height="34px;">检查问题内容</th>
                                <th><textarea type="text" name="content"  class="form-control" aria-describedby="basic-addon1" placeholder="请输入检查内容"></textarea>
                                </th>
                            </tr>
                            <tr>
                                <th>被监督检查机构</th>
                                ...
                                <th>检查问题扣分</th>
                                <th><input type="number" name="score"  class="form-control" aria-describedby="basic-addon1" placeholder="请输入检查问题扣分"></th>
                            </tr>
                            <input type="hidden" name="type" value="07"> <%--问责类型 --%>
                ...
                <div id="EditDiv" class="white_content">
                    ...
                    <form  class='form-horizontal clearfix' id="editPostForm" method="post" enctype="multipart/form-data">
                        <table class="table" style="height: 300px;text-align: left;">
                            <tr>
                                <th height="34px;">检查问题来源</th>
                                <th><input type="text" name="source"  class="form-control" aria-describedby="basic-addon1" placeholder="请输入检查问题来源" >
                                </th>
                                <th height="34px;">检查问题内容</th>
                                <th><textarea  name="content"  class="form-control" aria-describedby="basic-addon1" placeholder="请输入检查问题内容"></textarea>
                                </th>
                            </tr>
                            <tr>
                                <th>被监督检查机构</th>
