...
<!-- 二级标签选中 -->
<input id="nav-flag-sub" type="hidden" value="nav-flag-sub-gdgx-xcjzkh" />
<!-- 导航辅助 结束 -->
    ...
    <div class="minheight">
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">巡查机制</div>
                ...
                <div id="MyDiv" class="white_content">
                    ...
                    <form  class='form-horizontal clearfix' id="addPostForm" method="post" enctype="multipart/form-data">
                        <table class="table" style="height: 300px;text-align: left;">
                            ...
                            <tr>
                                <th>巡查问题来源</th>
                                <th><input type="text" name="source"  class="form-control" aria-describedby="basic-addon1" placeholder="巡查问题来源"></th>
                                <th height="34px;">巡查问题内容</th>
                                <th><textarea type="text" name="content"  class="form-control" aria-describedby="basic-addon1" placeholder="请输入巡查问题内容"></textarea>
                                </th>
                            </tr>
                            <tr>
                                <th>被巡查机构</th>
                                ...
                                <th>巡查问题扣分</th>
                                <th><input type="number" name="score"  class="form-control" aria-describedby="basic-addon1" placeholder="请输入巡查问题扣分"></th>
                            </tr>
                            <input type="hidden" name="type" value="05"> <%--问责类型 --%>
                ...
                <div id="EditDiv" class="white_content">
                    ...
                    <form  class='form-horizontal clearfix' id="editPostForm" method="post" enctype="multipart/form-data">
                        <table class="table" style="height: 300px;text-align: left;">
                            <tr>
                                <th height="34px;">巡查问题来源</th>
                                <th><input type="text" name="source"  class="form-control" aria-describedby="basic-addon1" placeholder="请输入巡查问题来源" >
                                </th>
                                <th height="34px;">巡查问题内容</th>
                                <th><textarea  name="content"  class="form-control" aria-describedby="basic-addon1" placeholder="请输入巡查问题内容"></textarea>
                                </th>
                            </tr>
                            <tr>
                                <th>被巡查机构</th>
                        ...
                        <%--<input type="hidden" name="type" value="05"> &lt;%&ndash;类型&ndash;%&gt;--%>
                        <div class="btn-group" role="group" aria-label="" style="margin-left: 40%;">
