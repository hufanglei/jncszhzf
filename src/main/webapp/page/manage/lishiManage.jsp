...
<table id="dg" title="历史任务管理" class="easyui-datagrid"
  ...
  url="${pageContext.request.contextPath}/task/finishedList.action?groupId=${currentMemberShip.group.groupId}" fit="true" toolbar="#tb">
 <thead>
 	<tr>
 		<th field="cb" checkbox="true" align="center"></th>
 		<th field="id" width="60" align="center">任务ID</th>
 		<th field="subject" width="100" align="center">事项主题</th>
