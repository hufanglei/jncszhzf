...
<body>
	...
	<!-- 二级标签选中 -->
	<input id="nav-flag-sub" type="hidden" value="nav-flag-sub-tjfx-czbmbja" />
	<!-- 导航辅助 结束 -->
...
<!-- 	<script src="https://img.hcharts.cn/highcharts-plugins/highcharts-zh_CN.js"></script> -->
	...
	$(function () {
	    ...
	    function chartRefresh(){
	    	$.ajax({
				url:url_prefix+'/statistics/wbjFinishedIssue',
				async: false,
				method: 'post',
				dataType : 'json',
				data:{
