...
<!-- 二级标签选中 -->
<input id="nav-flag-sub" type="hidden" value="nav-flag-sub-dbrw"/>
<!-- 导航辅助 结束 -->
<div class='wrap'>
    <section>
        <div class="content">
...
<script src="${pageContext.request.contextPath}/static/js/issues/dbrw.js"></script>
