...
public class TMainIssueBean implements Serializable {
    /**
     *
     */
    ...
    private String zxczType;//自行处置的类型 1 街道处理 2  委办局(立案处理) 3 联办
    private String actualTime;//实际耗时(结案时间-开始时间)
    ...
    public String getZxczType() {
        return zxczType;
    }

    public void setZxczType(String zxczType) {
        this.zxczType = zxczType;
    }
